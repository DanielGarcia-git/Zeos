...
// Tenemos 22 canales ya que el canal 0 y 1 estan reservados para I/O estandard. Los demas para pipes.
...
struct task_struct {
  ...
  struct channel table_channels[MAX_CHANNELS];
  struct list_head free_channel;
};
